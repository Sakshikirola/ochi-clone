        ...
        <div className='absolute flex gap-10 top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%]'>
          <div className=' flex items-center justify-center w-[15vw] h-[15vw] rounded-full bg-zinc-100'>
            <div className='relative w-2/3 h-2/3 rounded-full bg-zinc-900 overflow-hidden'>
               <div style={{ transform: `rotate(${rotate}deg)` }} className="line absolute top-1/2 left-1/2 w-1/2 h-2 origin-left">
                  <div className="absolute right-0 -translate-y-1/2 top-1/2 w-6 h-6 rounded-full bg-zinc-100"></div>
               </div> 
            </div> 
          </div> 

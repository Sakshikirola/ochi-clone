...
const Footer = () => {
  return (
    <div className='relative px-16 py-10 w-full flex justify-between'> 
      <div>
        <h1 className='uppercase text-[6.5vw] leading-[6vw] tracking-tighter font-bold font-["Founders Grotesk"]'>Eye-</h1>
        <h1 className='uppercase text-[6.5vw] leading-[6vw] tracking-tighter font-bold font-["Founders Grotesk"]'>Opening</h1>
        <div className='absolute logo bottom-10'>
      ...
      <div>
        <h1 className='uppercase text-[6.5vw] leading-[6vw] tracking-tighter font-bold font-["Founders Grotesk"]'>Presentations</h1>
        <div className='mt-6'>
            <h1 className='text-lg'>S:</h1>
            <div className='mt-4'>
                {["Instagram", "Behance", "Facebook", "Linkedin"].map((item,index)=>{
                  return <h1 className=' font-["Founders Grotesk"] underline'>{item}</h1>   
                })}
            </div>
        </div>
            ...
            <div>
              ...
              <div className='mt-4'>
                {["202-1965 W 4th Ave", "Vancouver, Canada"].map((item,index)=>{
                  return <h1 className='underline font-["Founders Grotesk"]'>{item}</h1>   
                })} 
              </div>
              <div className='mt-4'>
        ...
        <div className='mt-6'>
            ...
            <h1 className='mt-4 font-["Founders Grotesk"] underline'>hello@ochi.design</h1>
        </div>
        <div className='mt-10 flex justify-between'>
          <h1 className='text-zinc-400'>© ochi design 2026. <span className='underline'>Legal Terms</span></h1>
